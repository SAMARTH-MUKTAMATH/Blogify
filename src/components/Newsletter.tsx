...
export const Footer = () => {
  ...
  const scrollToNewsletter = () => {
    ...
    if (newsletterSection) {
      ...
      // Fallback: scroll to top if newsletter section not found
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-3">
            ...
            <div className="flex flex-col items-center lg:items-start gap-2">
              ...
              <div className="flex items-center gap-2 sm:gap-3 justify-center lg:justify-start w-full">
                ...
                {/* Newsletter Button - Cycling Text with Bell Ring Animation */}
                <button
                  onClick={scrollToNewsletter}
                  className="group flex items-center gap-1.5 px-2 sm:px-3 py-1.5 sm:py-2 rounded-lg bg-primary/30 hover:bg-primary/50 border border-primary/50 hover:border-primary/70 transition-all duration-300 hover:scale-105 hover:shadow-lg"
                >
                  <Bell className="w-3 h-3 sm:w-4 sm:h-4 text-foreground group-hover:animate-bounce transform-gpu" />
                  <span 
                    key={currentMessage} 
